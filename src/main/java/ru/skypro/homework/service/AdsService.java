...
public class AdsService {
    ...
    //Исправлено:setId - Id остаётся прежним, убран лишний setText, setAdvert
   ...
   //Исправлено - advert.getUsers это Users, userId это Long. Добавил getId
   ...
   //Исправлено - наше любимое, Integer to Long
